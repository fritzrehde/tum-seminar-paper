...
% This rule may seem unintuitive, but it was added so that iterators can be implemented.

% Dietl and Müller claim that Clarke's owners-as-dominators property is weakened "by allowing instances of inner classes to access the representation of the instance of the outer class they are associated with.
...
\subsection{Ownership as use-once variables}
...
% This chapter will focus on how ownership types are used in Rust.
