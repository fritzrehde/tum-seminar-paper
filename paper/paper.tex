...
Ralf Jung \cite{understanding-evolving-rust} provides a typical example of how ownership types can prevent a memory safety issue.
...
Notably, the \emph{push} method in line 3 has the following signature: \verb|pub fn push(&mut self, value: T)|.
