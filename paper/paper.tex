...
% This rule may seem quite unintuitive, which is underlined by the fact that Dietl et al.'s version of owners-as-dominators leave this rule out.

% Dietl et al. claim that Clarke's owners-as-dominators property is weakened "by allowing instances of inner classes to access the representation of the instance of the outer class they are associated with.
% Dietl et al. claim that, "by allowing instances of inner classes to access the representation of the instance of the outer class they are associated with, [...] they can handle iterators, but not more general forms of sharing."
% parametric ownership type systems describe ownership properties accurately and
% guarantee a strong type invariant, ownership parametricity increases the complexity
% of the type system and the annotation overhead.
...
% TODO: mention that all objects that can be referenced can be mutated
