...
\begin{itemize}
  \item Rust's ownership system: extended version of owners-as-modifiers
  \begin{itemize}
    \item immutable (read-only) and mutable references allowed (not in owners-as-dominators)
...
\begin{frame}{Transferring ownership}
  Big difference to theoretical ownership types
\end{frame}
