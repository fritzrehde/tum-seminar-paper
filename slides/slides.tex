...
\begin{itemize}
  ...
  % TODO: example
  \item unintentional aliases $\rightarrow$ bugs, hard to detect
  \item ownership types goal: restrict object aliasing (through rules) $\rightarrow$ improve memory safety
\end{itemize}
\end{frame}
...
\begin{itemize}
  \item ownership types goal: improve memory safety
...
\begin{frame}[fragile]{Memory safety: example}
C++
...
\begin{frame}{From theory to Rust}
\begin{itemize}
\end{itemize}
\end{frame}
