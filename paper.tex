...
% The article reveals that around 70 percent of the vulnerabilities of Microsoft and Google\cite{google-memory-safety}, specifically in their browser Chrome, were the result of memory safety issues.
