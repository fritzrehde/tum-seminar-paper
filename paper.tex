...
One such flavor is the owners-as-dominators invariant \cite{ownership-types-survey}, where the heap is structured as a tree with each object being inside its owner.
...
The value that immutable references refer to may not be modified, otherwise the program will not compile.
